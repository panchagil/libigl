...
npe_arg(v, dense_f64)
npe_arg(f, dense_i32)
npe_arg(handle_m_match, dense_f64)
...
if (dtype.type() == npe::type_f32) {
    dense_f32 is_singularity;
    dense_f32 singularity_index;
    igl::find_cross_field_singularities(v, f, handle_m_match, is_singularity, singularity_index);
    return std::make_tuple(    npe::move(is_singularity),
    npe::move(singularity_index));
} else if (dtype.type() == npe::type_f64) {
    dense_f64 is_singularity;
    dense_f64 singularity_index;
    igl::find_cross_field_singularities(v, f, handle_m_match, is_singularity, singularity_index);
